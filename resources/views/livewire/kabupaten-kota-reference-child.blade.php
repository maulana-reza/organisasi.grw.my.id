<div>
    ...
    <x-tall-crud-dialog-modal wire:model.live="confirmingItemCreation">
        ...
        <x-slot name="content"><div class="grid grid-cols-2 gap-8">
            <div class="mt-4">
                <x-tall-crud-label>Nama Kabupaten</x-tall-crud-label>
                <x-tall-crud-input class="block mt-1 w-full" type="text" wire:model="item.nama_kabupaten" />
                @error('item.nama_kabupaten') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message> @enderror
            </div>
